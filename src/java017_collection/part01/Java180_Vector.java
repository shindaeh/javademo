...
//① List인터페이스 구현한 클래스는 Vector, ArrayList, LinkedList 등이 있다. // Vector는 요즘 사용 안함
//② Set  인터페이스을 구현한 클래스는 HashSet, TreeSet 등이 있다. // 이름에 Tree가 들어가는 것은 정렬을 해준다는 것
...
public class Java180_Vector {
	...
	public static void main(String[] args) {
		...
		// add마다 index(0)부터 숫자가 붙는다. -> v.add(10)은 index(0)이란 뜻
		v.add(10);
		v.add(20);
		v.add(30);
