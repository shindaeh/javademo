...
public class Java021_switch {
	...
	public static void main(String[] args) {
		int jumsu = 100;
		// 90이상 : A, 90미만 ~ 80이상 : B, 80미만 ~ 70이상 : C, 70미만 ~ 60 이상 : D, 60미만 : F
		switch(jumsu / 10) {
		case 10 :
			/*
			 * case 9: System.out.printf("점수가 %d이므로 학점은 %c입니다."\n, jumsu, 'A'); break; case
			 * 8: System.out.printf("점수가 %d이므로 학점은 %c입니다."v, jumsu, 'B'); break; case 7:
			 * System.out.printf("점수가 %d이므로 학점은 %c입니다."\n, jumsu, 'C'); break; case 6:
			 * System.out.printf("점수가 %d이므로 학점은 %c입니다."\n, jumsu, 'D'); break; default :
			 * System.out.printf("점수가 %d이므로 학점은 %c입니다.",\n jumsu, 'F'); break;
			 */
		}
	} // end main()
